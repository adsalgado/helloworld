			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="paterno" title="${message(code: 'usuario.paterno.label', default: 'Paterno')}" />
					
						<g:sortableColumn property="materno" title="${message(code: 'usuario.materno.label', default: 'Materno')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: usuarioInstance, field: "paterno")}</td>
					
						<td>${fieldValue(bean: usuarioInstance, field: "materno")}</td>
